...
export function Qualifications({ initialQualifications }: QualificationsProps) {
  ...
  useEffect(() => {
    // Skip first load if we have initial data and type is Experience (default)
    if (type === QualificationType.Experience && initialQualifications.length > 0 && qualifications === initialQualifications) {
       return;
    }
